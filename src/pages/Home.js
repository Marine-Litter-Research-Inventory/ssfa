    ...
    <div>
      ...
      <Wrapper>
        ...
        <Container maxWidth='md'>
          ...
          <Body variant='body1' align='justify'>
            This website provides access to the Regional Research Inventory 2.0 of marine plastics research in the seas of East Asia. Its development has been coordinated by the National University of Singapore (NUS) and completed in November 2021 with the view of supporting the development of a regional node of the Global Partnership for Marine Litter (GMPL) under the leadership of the Coordinating Body for the Seas of East Asia (COBSEA).             <br />
          </Body>
      ...
      <Container maxWidth="md">
        ...
        {/* <HeaderRibbon
          ...
          variant="h6"
        /> */}
        <strong style={{ marginLeft: 20, fontSize: 20 }}>Publications included in the inventory</strong>
        <Body align="justify">
        ...
        <strong style={{ marginLeft: 20, fontSize: 20 }}>Organisation of the publication and extracted data</strong>
        <Body align="justify">
        ...
        <strong style={{ marginLeft: 20, fontSize: 20 }}>A regional team effort</strong>
        <Body align="justify">
